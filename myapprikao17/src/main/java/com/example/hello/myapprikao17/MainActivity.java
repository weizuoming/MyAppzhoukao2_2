...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshScrollView = (PullToRefreshScrollView) findViewById(R.id.refresh_scroll_view);
        viewPager = (ViewPager) findViewById(R.id.image_view_pager);
        listView = (ListView) findViewById(R.id.scroll_list_view);
        //失去焦点
    ...
    private void lunBoTu() {
        NetDataUtil.getData("http://v3.wufazhuce.com:8000/api/reading/index/?version=3.5.0&platform=android", MainActivity.this, new JsonCallBack() {
            @Override
            public void getJsonString(String json) {
                ...
                ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(MainActivity.this, imageUrlList);
    ...
    private void getRefreshData() {
        NetDataUtil.getData("http://gank.io/api/data/Android/10/1", MainActivity.this, new JsonCallBack() {
            @Override
            public void getJsonString(String json) {
                //解析
                Gson gson = new Gson();
    ...
    private void setAdapter() {
        if (listViewAdapter == null){
            listViewAdapter = new MyAdapter(MainActivity.this,list);
