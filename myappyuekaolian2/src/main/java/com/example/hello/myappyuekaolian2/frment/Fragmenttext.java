...
import com.example.hello.myappyuekaolian2.adapert.ViewPagerAdapter;
import com.example.hello.myappyuekaolian2.bean.DataDataBean;
import com.example.hello.myappyuekaolian2.bean.LunBoBean;
...
public class Fragmenttext extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshScrollView = view.findViewById(R.id.refresh_scroll_view2);
